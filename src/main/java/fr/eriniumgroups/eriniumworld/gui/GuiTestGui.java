...
package fr.eriniumgroups.eriniumworld.gui;
...
public class GuiTestGui extends ElementsEriniumworldMod.ModElement{
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiTestGui(ElementsEriniumworldMod instance) {
		super(instance, 6);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				EriniumworldMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
			...
			this.buttonList.add(new GuiButtonImage(0, this.guiLeft + 36, this.guiTop + 48, 150, 20, new ResourceLocation("eriniumworld:textures/test_button.png")){
		     ...
		     public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
		          if (this.visible) {
		              ...
		              if(this.hovered){
		                drawTexturedModalRect(this.x, this.y, 0, this.height, this.width, this.height);
		              }else {
	...
	private static class GuiButtonImage extends GuiButton {
    public final ResourceLocation texture;
    int imageWidth;
    int imageHeight;
    public GuiButtonImage(int buttonId, int x, int y, int width, int height, ResourceLocation texture) {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
		...
		protected void actionPerformed(GuiButton button) {
			EriniumworldMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
